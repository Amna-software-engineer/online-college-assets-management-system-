    ...
    <div className="w-full flex flex-col">
      ...
      <div className="w-full h-16 bg-[#008BA9] flex items-center justify-between px-4 md:px-8 text-white shadow-md relative">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* 3. Title */}
          <h1 className="text-[8px] sm:text-lg md:text-xl font-black italic tracking-widest uppercase truncate max-w--none">
            {role === 'Principal' ? 'Principal' : user.department?.name + ' Department'}
          </h1>
        </div>
