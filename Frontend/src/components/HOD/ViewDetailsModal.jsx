...
const ViewDetailsModal = ({ isOpen, onClose, asset,totalUnits }) => {
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm font-semibold text-slate-800 mt-1">
              {asset.assignedTo?.name || "Main Store / Warehouse"}
            </p>
          </div>
            ...
            <div className="relative border-l-2 border-slate-200 pl-6 space-y-8">
              {asset.history.map((log, idx) => (
                <div key={idx} className="relative">
                  ...
                  {/* Dot */}
                  <div className="absolute -left-[33px] top-1 w-4 h-4 bg-[#008BA9] rounded-full border-4 border-white shadow" />
